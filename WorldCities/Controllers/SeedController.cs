...
namespace WorldCities.Controllers
{
    ...
    public class SeedController : ControllerBase
    {
        ...
        {
            // presents non-development environments from running this method
            ...
            // save all the cities in the Database
        ...
        public async Task<ActionResult> CreateDefaultUsers()
        {
            ...
            if (await _roleManager.FindByNameAsync(email_User) == null)
            {
